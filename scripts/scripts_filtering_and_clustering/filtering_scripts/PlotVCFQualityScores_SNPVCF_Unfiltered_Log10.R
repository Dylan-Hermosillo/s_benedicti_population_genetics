...
scores <- read.csv("QualityScores_SNPVCF_Unfiltered.table", header = TRUE, sep = "\t")

#DP
df_DP <- data.frame(DP = log10(scores$DP))
png("SNPVCF_DP_Density.png", width=1600, height=1200)
...
png("SNPVCF_QD_Density.png", width=1600, height=1200)
...
png("SNPVCF_FS_Density.png", width=1600, height=1200)
...
png("SNPVCF_MQ_Density.png", width=1600, height=1200)
...
png("SNPVCF_MQRankSum_Density.png", width=1600, height=1200)
...
png("SNPVCF_SOR_Density.png", width=1600, height=1200)
...
png("SNPVCF_ReadPosRankSum_Density.png", width=1600, height=1200)
